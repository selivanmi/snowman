...
class TestStringMethods(unittest.TestCase):
  ...
  def test_mother_string(self):
      ...
      self.assertEqual(string_to_alpha.process_string(s), ['mother', 'cleans', 'the', 'window'])

  def test_empty_string(self):
      s = ''
      self.assertEqual(string_to_alpha.process_string(s), [])

  def test_no_spaces_string(self):
      s = 'mothercleansthewindow'
      self.assertEqual(string_to_alpha.process_string(s), ['mothercleansthewindow'])
